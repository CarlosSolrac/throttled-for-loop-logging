...
internal static partial class Log
{
    ...
    [LoggerMessage(EventId = 9001, Message = "{OperationName} ({OperationId}) succeeded in {ElapsedSeconds}s — {Processed} processed, {Failed} failed. {Note}")]
    ...
    [LoggerMessage(EventId = 9002, Message = "{OperationName} ({OperationId}) failed after {ElapsedSeconds}s — {Processed} processed, {Failed} failed")]
    ...
    [LoggerMessage(EventId = 9003, Message = "{OperationName} ({OperationId}) ended without an outcome after {ElapsedSeconds}s — {Processed} processed, {Failed} failed")]
    ...
    [LoggerMessage(EventId = 9004, Message = "{OperationName} item {ItemLabel} {Outcome} — {Processed}/{TotalItems} done, {Failed} failed, new={IsNew}, submitted {SubmittedAtUtc:O}, {SuppressedSince} held since last line, {RatePerSecond}/s, ETA {EtaSeconds}s ({EtaLowSeconds}–{EtaHighSeconds}s)")]
    ...
    [LoggerMessage(EventId = 9006, Message = "{OperationName} finished with failures — {Failed} of {TotalItems} failed in {ElapsedSeconds}s. {Breakdown}. Last failure: {LastFailureLabel} at {LastFailureAtUtc:O}")]
